...
describe("Car", () => {
    ...
    beforeEach(async (done: () => void) => {
        car = new Car(new Vector3(), new MockEngine());
        await car.init();
